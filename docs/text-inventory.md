...
|------|--------------|-------------------|
| Zhu Zi Yu Lei | ctext.org API | `data/processed/zhuziyulei/` |
| Shisan Jing Zhushu | `data/raw/Shisan_Jing_Zhushu/` | `data/processed/<text-slug>/` |
| Kongzi Jiayu | `data/raw/kongzi_jiayu/` | `data/processed/kongzi-jiayu/` |
| Rizhilu | `data/raw/rizhilu/` | `data/processed/rizhilu/` |
| Nandikkalambakam | `data/raw/nandikkalambakam/nandikkalambakam-clean.txt` | `data/processed/nandikkalambakam/` |
| Yashodhara Kaviyam | `data/raw/yashodhara-kaviyam/` | `data/processed/yashodhara-kaviyam/` |
| Udayanakumara Kaviyam | `data/raw/udayanakumara-kaviyam/` | `data/processed/udayanakumara-kaviyam/` |
| Eustathius Odyssey | `data/raw/eustathius-odyssey/` | `data/processed/eustathius-odyssey/` |
